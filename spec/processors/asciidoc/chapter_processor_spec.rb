...
module Twist
  module Processors
    module Asciidoc
      RSpec.describe ChapterProcessor do
        ...
        let(:element_repo) { Twist::Repos::ElementRepo.new }
        let(:image_repo) { Twist::Repos::ImageRepo.new }
        ...
        context "normal elements" do
          ...
          context "div.sect2 w/ h3 & div.para" do
            let(:content) do
              <<-HTML
              <div class="sect2">
                <h3 id="_sect_2_title">1.1. Sect2 title</h3>
                <div class="paragraph">
            ...
            it "adds the h3 and para elements to the chapter" do
              ...
              expect(h2_element.content).to eq(%q{<h2 id="_sect_2_title">1.1. Sect2 title</h2>})
        ...
        context "div.sect2 w/ h3 & div.para containing a footnote" do
          ...
          it "links footnotes to this chapter" do
            ...
            footnote_1 = footnote_repo.by_identifier_and_chapter(identifier_1, chapter)
            expect(footnote_1).not_to be_nil

            footnote_2 = footnote_repo.by_identifier_and_chapter(identifier_2, chapter)
            expect(footnote_2).not_to be_nil
          end
        end
        ...
        context "li containing a footnote" do
          ...
          it "links footnotes to this chapter" do
            ...
            footnote_1 = footnote_repo.by_identifier_and_chapter(identifier, chapter)
            expect(footnote_1).not_to be_nil
          end
        end
